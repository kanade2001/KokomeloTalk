export const ClientConversation: React.FC<{ text: string }> = ({ text }) => {
  return (
    <div className="w-full flex justify-end">
      ...
      >
        {text}
        <div className="absolute right-0 top-full w-0 h-0 border-t-[10px] border-t-blue-600 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent"></div>
      </div>
    </div>
  );
};
